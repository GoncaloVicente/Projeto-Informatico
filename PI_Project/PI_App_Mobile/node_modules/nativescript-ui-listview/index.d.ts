...
export class RadListView extends View {
    ...
    */
    ...
    /**
    * Identifies the {@link itemSelectedBackgroundColor} dependency property.
    */
    static itemSelectedBackgroundColorProperty: Property<RadListView, Color>;
    ...
    */
    ...
    /**
     * Gets or sets the background color of the selected item in {@link RadListView}.
     */
    ...
    */
    ...
    /**
     * Must be called when data is delivered after a load-on-demand request has been made. It's an alternative optimized version
     * of the above method which handles the case where only new items have been appended to the end of the list.
     *  Params:
     * 'itemsCount' - The number of items that have been appended
     * 'disableLoadOnDemand' - indicates if the "loadOnDemandMode" should be reset to 'None' after the event cycle is finished
     */
