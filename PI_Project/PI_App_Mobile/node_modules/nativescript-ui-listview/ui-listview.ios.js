...
var SystemColoredStackLayout = /** @class */ (function (_super) {
    __extends(SystemColoredStackLayout, _super);
    function SystemColoredStackLayout() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SystemColoredStackLayout.prototype.initNativeView = function () {
        this.nativeViewProtected.backgroundColor = utils_1.ios.MajorVersion <= 12 ? UIColor.whiteColor : UIColor.systemBackgroundColor;
    };
    return SystemColoredStackLayout;
...
var ListViewLinearLayout = /** @class */ (function (_super) {
    ...
    function ListViewLinearLayout() {
        ...
        _this.dynamicItemSize = true;
        return _this;
    }
    ListViewLinearLayout.prototype.supportsDynamicSize = function () {
        return this.dynamicItemSize;
    };
    ListViewLinearLayout.prototype.getNativeLayout = function () {
        return TKListViewLinearLayout.new();
    };
    ListViewLinearLayout.prototype.onDynamicItemSizePropertyChanged = function (oldValue, newValue) {
        this.onDynamicItemSizeChanged(oldValue, newValue);
    };
    ListViewLinearLayout.prototype.onDynamicItemSizeChanged = function (oldValue, newValue) {
        this.dynamicItemSize = newValue;
    };
    ListViewLinearLayout.dynamicItemSizeProperty = new view_1.Property({
...
var RadListView = /** @class */ (function (_super) {
    ...
    RadListView.prototype._getDefaultGroupContent = function () {
        var parentStack = new SystemColoredStackLayout();
    ...
    RadListView.prototype._toggleSelectionColor = function (view, isSelected) {
        if (!view) {
            return;
        }
        if (isSelected) {
            view.backgroundColor = new colorModule.Color("transparent");
        }
        else if (view.backgroundColor && view.backgroundColor.toString() === new colorModule.Color("transparent").toString()) {
    ...
    RadListView.prototype.syncReorderMode = function () {
    ...
    RadListView.prototype.syncSelection = function () {
        if (this.nativeViewProtected) {
    ...
    RadListView.prototype.syncCellReorder = function () {
        if (this.nativeViewProtected) {
    ...
    RadListView.prototype.syncCellSwipe = function () {
        if (this.nativeViewProtected) {
    ...
    RadListView.prototype.syncPullToRefresh = function () {
        if (this.nativeViewProtected) {
    ...
    RadListView.prototype.syncLoadOnDemandMode = function () {
    ...
    RadListView.prototype.syncLoadOnDemandBufferSize = function () {
    ...
    RadListView.prototype.syncSelectionBehavior = function () {
    ...
    RadListView.prototype.scrollToIndex = function (index, animate, snapMode) {
        ...
        if (this.nativeViewProtected) {
            ...
            if (item !== undefined && section_1 !== undefined) {
    ...
    RadListView.prototype._getIndexForIndexPath = function (indexPath) {
        var index;
        if (!this.isDataOperationsEnabled) {
            index = indexPath.row;
        }
        else {
            var tappedItem = this._getDataItemFromSection(indexPath.row, indexPath.section);
    ...
    RadListView.prototype.notifyAppendItemsOnDemandFinished = function (itemsCount, disableLoadOnDemand) {
        this.notifyLoadOnDemandFinishedImpl(itemsCount, disableLoadOnDemand);
    };
    RadListView.prototype.notifyLoadOnDemandFinishedImpl = function (appendedItemsCount, disableLoadOnDemand) {
