...
var RadListView = /** @class */ (function (_super) {
    ...
    RadListView.prototype._toggleSelectionColor = function (view, isSelected) {
        ...
        var selectedColor = this.itemSelectedBackgroundColor ? this.itemSelectedBackgroundColor : new color_1.Color("#20000000");
        if (isSelected) {
    ...
    RadListView.prototype.notifyAppendItemsOnDemandFinished = function (_itemsCount, disableLoadOnDemand) {
