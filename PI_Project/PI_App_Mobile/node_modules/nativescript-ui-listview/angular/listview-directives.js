...
var RadListViewComponent = /** @class */ (function () {
    ...
    RadListViewComponent.prototype.ngDoCheck = function () {
        if (this._differ) {
            ...
            if (changes) {
                ...
                var removed_1 = 0;
                var changed_1 = 0;
                changes.forEachAddedItem(function () { return added_1++; });
                changes.forEachMovedItem(function () { return moved_1++; });
                changes.forEachRemovedItem(function () { return removed_1++; });
                changes.forEachIdentityChange(function () { return changed_1++; });
                if (platform_1.isIOS && added_1 > 0 && !moved_1 && !removed_1 && !changed_1) {
                    if (this._listView.nativeViewProtected) {
                        var nativePaths_1 = NSMutableArray.alloc().init();
                        changes.forEachAddedItem(function (item) {
                            nativePaths_1.addObject(NSIndexPath.indexPathForRowInSection(item.currentIndex, 0));
                        });
                        this._listView.nativeViewProtected.insertItemsAtIndexPaths(nativePaths_1);
                    }
                }
                else {
                    this._listView.refresh();
    ...
    RadListViewComponent.prototype.onItemLoadingInternal = function (args) {
        ...
        if (!ngView && args.view instanceof layout_base_1.LayoutBase && args.view.getChildrenCount() > 0) {
            ngView = args.view.getChildAt(0)[__1.NG_VIEW];
        }
        if (ngView) {
    ...
    __decorate([
        core_1.ViewChild("loader", { read: core_1.ViewContainerRef, static: true }),
    ...
    __decorate([
        core_1.ContentChild(core_1.TemplateRef, { read: core_1.TemplateRef, static: true }),
