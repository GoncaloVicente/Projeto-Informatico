...
/**
 Defines a block function that is used when creating a new cell in UITableView when using it with TKRLVDataSource.
...
/**
 Defines a block function that is used when initializing cell properties in UITableView when using it with TKRLVDataSource.
...
/**
 The settings that can be customized when using TKRLVDataSource with UITableView.
 */
