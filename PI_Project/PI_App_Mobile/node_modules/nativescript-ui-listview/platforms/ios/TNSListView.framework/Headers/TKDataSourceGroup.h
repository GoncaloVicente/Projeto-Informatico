...
/**
 Represents a group of items sharing the same group key in TKRLVDataSource.
 */
...
/**
 A display key specific for this group. TKRLVDataSource displayKey property is used if this property value is set to nil.
 */
@property (nonatomic, copy, nullable) NSString *displayKey;

/**
 A value key specific for this group. TKRLVDataSource valueKey property is used if this property value is set to nil.
 */
