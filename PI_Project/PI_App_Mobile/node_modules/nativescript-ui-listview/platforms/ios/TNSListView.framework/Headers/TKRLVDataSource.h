 ...
 * @discussion Represents an enum that defines the format of the data that can be parsed by TKRLVDataSource.
 */
...
/**
 Defines a block that is used when evaluating the text for an item in TKRLVDataSource.
...
/**
 Defines a block that is used when enumerating items in TKRLVDataSource.
...
/**
 Defines a block that is used when mapping the items in TKRLVDataSource.
...
/**
 Defines a block that is used when reducing the items in TKRLVDataSource to a single value.
...
/**
 Defines a block that is used when filtering items in TKRLVDataSource.
...
/**
 @discussion TKRLVDataSource is an adapter that consumes data from various sources and has functionality for data manipulations. It implements various data source protocols and can be used as a data source for TKChart, TKCalendar, TKListView, UITableView and UICollectionView.
 */
@interface TKRLVDataSource : NSObject <UITableViewDataSource,
                                    UITableViewDelegate,
...
/**
 Provides the ability to customize the appearance of TKRLVDataSource consumers. e.g. TKChart, TKCalendar, UITableView, etc.
 */
...
/**
 When parsing data from JSON TKRLVDataSource chaecks whether the mapClass property is set.
...
/**
 When set to YES TKRLVDataSource tries to map NSArray value proerties with instances of mapClass.
 */
