...
declare class TKRLVDataSource extends NSObject implements NSURLConnectionDataDelegate, NSURLConnectionDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UITableViewDataSource, UITableViewDelegate {

	static alloc(): TKRLVDataSource; // inherited from NSObject

	static new(): TKRLVDataSource; // inherited from NSObject
...
declare class TKListViewCellBackgroundView extends TKView {
	...
	checkViewFillColor: UIColor;

	updateStyle(): void;

	updateCheckViewForSelection(): void;
}
