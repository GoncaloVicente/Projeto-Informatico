...
export declare class ListViewLinearLayout extends ListViewLayoutBase {
    ...
    static dynamicItemSizeProperty: viewModule.Property<ListViewLinearLayout, boolean>;
...
export declare class RadListView extends commonModule.RadListView {
    ...
    _toggleSelectionColor(view: viewModule.View, isSelected: boolean): void;
    ...
    protected onItemSelectedBackgroundColorChanged(oldValue: colorModule.Color, newValue: colorModule.Color): void;
