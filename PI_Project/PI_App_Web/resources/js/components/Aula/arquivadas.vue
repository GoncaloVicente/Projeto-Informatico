                                    ...
                                    >
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-primary"
                                               v-on:click.prevent="desarquivar(aula)">Recuperar</a>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                title: "Lista de Aulas Arquivadas",
                total: 0,
                aulas: [],
                página: 1,
                viewDetails: false,
        ...
        methods: {
            ...
            getAulas: function () {
                ...
                ;
                axios.get("api/aulas/arquivadas?page=" + this.página + variables).then(response => {
            ...
            desarquivar: function (aula) {
                axios.patch("api/aula/desarquivar/" + aula.id).then(response => {
                    this.getAulas();
                });
            },
            ...
            clickCallback: function (page) {
                ...
                ;
                axios.get("api/aulas/arquivadas?page=" + page + variables).then(response => {
                    this.aulas = response.data.data;
                    this.total = response.data.total;
                });
            },
