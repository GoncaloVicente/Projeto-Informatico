                    ...
                    <div class="box-body no-padding">
                        ...
                        <div class="col-md-12">
                            ...
                            <vue-select @class="form-control" name="tema" label="nome" :filterable="true"
                                        ...
                                        v-model="$v.conteudo.tema_id.$model"
                                        style="background-color: #fff">
                                <span slot="no-options">Não existem opções compatíveis!</span>
                            </vue-select>
                            <div class="error" style="color:red"
                                 v-if="!$v.conteudo.tema_id.required && $v.conteudo.tema_id.$anyDirty"><strong>Tema é obrigatório</strong></div>
                            <br>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="form-group col-md-12">
                            <a class="btn btn-primary" @click.prevent="!$v.$invalid ? saveNewConteudo() : showErrors()">Guardar</a>
                            <a class="btn btn-light" v-on:click.prevent="cancelNewConteudo()">Cancelar</a>
                        </div>
                        <br>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            saveNewConteudo() {
                this.$emit('save-NewConteudo', this.conteudo)
            },
            cancelNewConteudo() {
                this.$emit('cancel-NewConteudo')
            },
