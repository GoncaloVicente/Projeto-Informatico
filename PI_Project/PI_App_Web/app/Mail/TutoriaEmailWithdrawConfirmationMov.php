...
class TutoriaEmailWithdrawConfirmationMov extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject('Tutoria Confirmação Retirada '.$this->tutoria->assunto)
            ->markdown('emails.tutoriaWithdrawConfirmationMov');
    }
}